...
.card div img:nth-of-type(1) {
    width: 50px;
}

.card div img:nth-of-type(2) {
    width: 40px;
}

.card div img:nth-of-type(2):hover {
    cursor: pointer;
}
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;IACI,sBAAsB;IACtB,UAAU;IACV,SAAS;AACb;;AAEA;IACI,gCAAgC;IAChC,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,cAAc;IACd,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,6BAA6B;IAC7B,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,cAAc;AAClB;;AAEA;IACI,YAAY;IACZ,iBAAiB;IACjB,uBAAuB;IACvB,gCAAgC;IAChC,kBAAkB;AACtB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,gCAAgC;IAChC,uBAAuB;;AAE3B;;AAEA;IACI,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,WAAW;IACX,iBAAiB;AACrB;;;AAGA;IACI,YAAY;IACZ,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,6BAA6B;IAC7B,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,SAAS;IACT,iBAAiB;AACrB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,eAAe;AACnB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Kanit&display=swap');\n\n*, *::after, *::before {\n    box-sizing: border-box;\n    padding: 0;\n    margin: 0;\n}\n\nbody {\n    font-family: 'Kanit', sans-serif;\n    color: white;\n}\n\n#container {\n    width: 500px;\n    margin: 0 auto;\n    display: flex;\n    flex-direction: column;\n    gap: 20px;\n    /* border: 1px solid black; */\n    align-items: center;\n}\n\n.form-container {\n    padding: 10px;\n    border-radius: 20px;\n    background-color: white;\n}\n\nform {\n    display: flex;\n    /* gap: 2px; */\n}\n\ninput {\n    width: 450px;\n    font-size: 1.1rem;\n    border: 1px solid black;\n    border-radius: 10px 0px 0px 10px;\n    padding-left: 10px;\n}\n\nbutton {\n    width: 30px;\n    height: 30px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    border-radius: 0px 10px 10px 0px;\n    border: 1px solid black;\n\n}\n\nbutton img {\n    width: 20px;\n    height: 20px;\n}\n\n.loading {\n    visibility: hidden;\n    width: 30px;\n    margin-left: 10px;\n}\n\n\n.card {\n    width: 450px;\n    display: flex;\n    flex-direction: column;\n    gap: 10px;\n    /* border: 1px solid black; */\n    font-size: 1.6rem;\n}\n\n.card div {\n    display: flex;\n    align-items: center;\n    gap: 15px;\n    font-size: 1.7rem;\n}\n\n.card div p {\n    width: 4ch;\n}\n\n.card div img:nth-of-type(1) {\n    width: 50px;\n}\n\n.card div img:nth-of-type(2) {\n    width: 40px;\n}\n\n.card div img:nth-of-type(2):hover {\n    cursor: pointer;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _images_fahrenheit_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/fahrenheit.png */ "./src/images/fahrenheit.png");
/* harmony import */ var _images_celsius_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/celsius.png */ "./src/images/celsius.png");
/* harmony import */ var _images_background_jpg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/background.jpg */ "./src/images/background.jpg");
/* harmony import */ var _images_loading_gif__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./images/loading.gif */ "./src/images/loading.gif");
...
const dom = (() => {
    ...
    function init() {
        ...
        loading.src = _images_loading_gif__WEBPACK_IMPORTED_MODULE_5__
        searchIcon.src = _images_search_png__WEBPACK_IMPORTED_MODULE_1__
        searchButton.appendChild(searchIcon)

        document.body.style.backgroundImage = `url(${_images_background_jpg__WEBPACK_IMPORTED_MODULE_4__})`
    }
    ...
    function updateCard(data, unit){
        ...
        time.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(data.localtime), 'EEEE, MMMM d, yyyy - p')
        ...
        if (unit === 'C'){
            ...
            tempUnit.src = _images_celsius_png__WEBPACK_IMPORTED_MODULE_3__    
        }
        else {
            temperature.textContent = data.temp_f    
            tempUnit.src = _images_fahrenheit_png__WEBPACK_IMPORTED_MODULE_2__
        }   
    }
...
module.exports = __webpack_require__.p + "59c594cac474f07edc45.jpg";
...
module.exports = __webpack_require__.p + "f9de845bcf67b37134c7.png";
...
module.exports = __webpack_require__.p + "df0a8e29f572164c39e0.png";
...
module.exports = __webpack_require__.p + "9209fca0fbb740a8d1f6.gif";
...
form.addEventListener('submit', async (event) => {
    ...
    _dom_js__WEBPACK_IMPORTED_MODULE_0__.dom.switchLoadingCircle()
    const response = await _api_js__WEBPACK_IMPORTED_MODULE_1__.weatherAPI.getCurrentWeatherInfo(search.value)
    const data = _api_js__WEBPACK_IMPORTED_MODULE_1__.weatherAPI.processWeatherData(response)

    _dom_js__WEBPACK_IMPORTED_MODULE_0__.dom.updateCard(data)
    _dom_js__WEBPACK_IMPORTED_MODULE_0__.dom.switchLoadingCircle()
